...
{{< callout type="point" title="リクルートエージェントはこんな人向け" >}}
求人数の多さは最大の強み。「看護師経験は関係なくても一般企業に転職したい」という意志が固まっている人に最適。給与が下がる覚悟を持って使うと効果的。
{{< /callout >}}
...
{{< callout type="warning" title="一般企業転職で覚悟しておく2つの現実" >}}
①看護師の給与水準より大幅に下がる可能性が高い　②医療スキルは評価されるが、PC・ビジネスマナー・数字管理など「一般企業スキル」は別途学ぶ必要がある。それでも行く、という覚悟が転職成功の鍵。
{{< /callout >}}
...
{{< callout type="point" title="産業保健師を目指すなら特化エージェント一択" >}}
リクルートエージェントやdodaは産業保健求人の網羅性に限界がある。「アポプラス保健師」や「さんぽJOB」のような産業保健特化サービスを使うことで、非公開求人も含めた本命求人にたどり着きやすくなる。
{{< /callout >}}
...
{{< callout type="memo" title="一般企業向け職歴書の書き方のコツ" >}}
「何をしたか」ではなく「どんな課題にどう対応したか・どんな成果を出したか」の視点で書く。「看護師免許保有」より「健康管理・保健指導・緊急時対応が可能」と具体的に表現する方が採用担当者に刺さる。
{{< /callout >}}
